...
class TAttacker(Tactic):
    ...
    def bisector_bot_wt(self,state):
        ...
        for i in xrange(len(state.homePos)):
            if i==self.bot_id or i==state.our_goalie: 
                continue
        ...
        for our_bot in xrange(len(state.homePos)):
            if our_bot is self.bot_id or our_bot == state.our_goalie:
                continue
    ...
    def bot_ourgoal_angle(self,state):
        ...
        for i in xrange(len(state.homePos)):
            if i is self.bot_id or i == state.our_goalie:
                continue
    ...
    def calculate_score(self, state,BOTiD):
        ...
        our_bot=0
        for i in xrange(len(state.homePos)):
            if i is BOTiD or i == state.our_goalie:
