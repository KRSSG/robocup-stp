...
class pCordinatedPass2(object):
    def __init__(self):
        ...
        self.role_list[0][0] = "TPrimaryDefender"
        self.role_list[0][1] = params

    def tactic_instance(self, bot_id, tactic_id, params, other_bot_id=-1):
        
        
        if tactic_id == "TPrimaryDefender":
            instance = tactic_factory.TPrimaryDefender.TPrimaryDefender(0, self.state, params)
        return instance
    ...
    def bs_callback(self, data):
        ...
        tac_1.execute(self.state, self.pub, 2)
